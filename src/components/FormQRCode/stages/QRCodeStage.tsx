    ...
    switch (activeTab) {
      case "shapes":
        ...
        const shapeCategories = Array.from(
          new Set(svgShapeFiles.map((shape) => shape.category))
        );
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-5 gap-3">
                <button
                  className={`p-3 border-2 rounded-lg flex flex-col items-center space-y-1 transition-all hover:shadow-md ${
                    !qrCodeSettings.frameStyle ||
                    qrCodeSettings.frameStyle === "none"
                      ? "border-blue-500 bg-blue-50 shadow-md scale-105"
                      : "border-gray-200 hover:border-gray-300"
                  }`}
                  onClick={() =>
                    onUpdateQRCodeSettings({ frameStyle: "none", shapeSvg: "" })
                  }>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <button
                      ...
                      onClick={() =>
                        onUpdateQRCodeSettings({
                          noisePattern: pattern.id as any,
                        })
                      }>
    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-md text-gray-600">
          Design your QR code with custom shapes and effects
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-white border border-gray-200 rounded-lg p-6 text-center sticky top-8">
            ...
            <div
              id="qr-preview"
              className="bg-gray-50 rounded-lg p-4 mb-4 flex justify-center">
              {qrComponent}
            </div>
